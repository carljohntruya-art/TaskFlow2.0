    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-slate-50 dark:bg-[#0f172a] py-10">
      ...
      <div className="w-full max-w-md p-6 relative z-10">
        <div className="flex flex-col items-center mb-8">
           <div className="relative inline-flex items-center justify-center mb-6">
              ...
              <div 
                ...
                style={{
                  ...
                  borderRadius: '20px',
                  boxShadow: '0 0 0 1px rgba(99, 179, 255, 0.2), 0 8px 32px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255,255,255,0.08)',
              ...
              >
                 <img 
                    ...
                    style={{
                      filter: 'drop-shadow(0 2px 8px rgba(99, 179, 255, 0.4))'
                    }}
                 />
              </div>
           </div>
           ...
           <p className="text-slate-500 dark:text-slate-400 text-sm mt-2 text-center">Enter your details to access your account</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
           ...
           <button onClick={() => navigate('/register')} className="text-primary font-semibold hover:text-blue-500 transition-colors ml-1">Create one</button>
        </div>
      </div>
    </div>
  );
